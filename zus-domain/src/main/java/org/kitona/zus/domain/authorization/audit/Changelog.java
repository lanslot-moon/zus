...
public class Changelog {
     ...
     * @return 变更日志实体
     */
    public static Changelog createWriteLog(String storeId, TupleKey tupleKey, Long zookie) {
        return createWriteLog(storeId, tupleKey, zookie, AuditMetadata.EMPTY);
    }

    public static Changelog createWriteLog(String storeId, TupleKey tupleKey, Long zookie,
                                           AuditMetadata auditMetadata) {
        return createLog(storeId, tupleKey, zookie, OPERATION_WRITE, auditMetadata);
    }
     ...
     * @return 变更日志实体
     */
    public static Changelog createDeleteLog(String storeId, TupleKey tupleKey, Long zookie) {
        return createDeleteLog(storeId, tupleKey, zookie, AuditMetadata.EMPTY);
    }

    public static Changelog createDeleteLog(String storeId, TupleKey tupleKey, Long zookie,
                                            AuditMetadata auditMetadata) {
        return createLog(storeId, tupleKey, zookie, OPERATION_DELETE, auditMetadata);
    }

    /**
     * 创建变更日志（内部方法）
     */
    private static Changelog createLog(String storeId, TupleKey tupleKey, Long zookie,
        ...
        AuditMetadata safeAudit = auditMetadata != null ? auditMetadata : AuditMetadata.EMPTY;
        entity.operatorId = safeAudit.operatorId();
        entity.requestId = safeAudit.requestId();
        entity.source = safeAudit.source();
     ...
     * @return 重建后的实体
     */
    public static Changelog reconstitute(String storeId, Long zookie, String operation,
                                         String objectType, String objectId, String relation,
                                         String subjectType, String subjectId, String subjectRelation,
                                         String operatorId, String requestId, String source,
                                         Long operationTime) {
        Changelog entity = new Changelog();
        entity.storeId = storeId;
