...
/**
 * Watch 应用服务：通过 IChangelogDomainRepository 查询变更日志供 API 层 SSE 推送。
 *
 * @author kitona
 * @version 1.1.0
 * @since 2025-01-15
...
public class WatchApplicationService implements IWatchApplicationService {
    ...
    public List<WatchChangeResultDTO> getChanges(String storeId, Long startAt, int limit) {
        ...
        List<ChangelogEntity> list = changelogRepository.findAfterZookie(storeId, after, effectiveLimit);
    ...
    public long getCurrentZookie(String storeId) {
        ...
        Long max = changelogRepository.getMaxZookie(storeId);
