 ...
 *
 * <p>与 {@link IModelApplicationService} 的职责边界：
 * <ul>
 *   <li>{@link IModelApplicationService}：模型的<strong>生命周期</strong>（创建、发布、废弃、删除等）</li>
 ...
 * @version 1.0.0
 * @since 2025-02-06
 * @see IModelApplicationService
 */
public interface IModelSchemaApplicationService {
     ...
     */
    List<TypeDefinitionResultDTO> listTypeDefinitions(String storeId, String modelId);
     ...
     */
    TypeDefinitionResultDTO getTypeDefinition(String storeId, String modelId, String type);
     ...
     */
    List<RelationResultDTO> listRelations(String storeId, String modelId, String type);
     ...
     */
    RelationResultDTO getRelation(String storeId, String modelId, String type, String relationName);
