 ...
 *
 *
 * 复制于 org.springframework.util.ReflectionUtils
 */
...
public abstract class ReflectionUtil {
    ...
    public static Method findMethod(Class<?> clazz, String name, Class<?>... paramTypes) {
        ...
        if (StringUtils.isBlank(name)) {
            throw new IllegalStateException("Method name must not be blank");
        }
    ...
    public interface MethodFilter {
        ...
        default MethodFilter and(MethodFilter next) {
            if (next == null) {
                throw new IllegalArgumentException("Next MethodFilter must not be null");
            }
    ...
    public interface FieldFilter {
        ...
        default FieldFilter and(FieldFilter next) {
            if (next == null) {
                throw new IllegalArgumentException("Next FieldFilter must not be null");
            }
