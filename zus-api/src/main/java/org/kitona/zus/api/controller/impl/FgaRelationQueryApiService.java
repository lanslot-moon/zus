 ...
 * 对应能力，先返回 501 错误，待领域授权视图展开能力落地后接入。
 *
 * @author kitona
 * @since 2026-04-18
 */
...
public class FgaRelationQueryApiService implements IFgaAuthViewApiService {
    ...
    public RestResult<FgaListSubjectsResponseVO> listSubjects(String storeId, FgaListSubjectsRequest request) {
        log.debug("FgaRelationQueryApiService.listSubjects storeId={}, objectType={}, relation={}",
                storeId,
    ...
    public RestResult<FgaExpandTreeVO> expand(String storeId, FgaExpandRequest request) {
        ...
        return RestResult.error(501, "expand 接口待领域层授权视图展开能力落地后启用");
    }
}
