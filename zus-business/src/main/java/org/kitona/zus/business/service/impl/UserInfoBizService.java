...
public class UserInfoBizService implements IUserInfoBizService {
    ...
    public UserInfoDTO getUserInfo(String userId) {
        ...
        UserInfoDTO convert = MapstructUtil.convert(userInfo, UserInfoDTO.class);
        convert.setEmail(userAddress);
        log.info("UserInfoBizService getUserInfo success, userId:{}, userInfo:{}", userId, JacksonUtil.toJSONString(convert));
        return convert;
    }
}
