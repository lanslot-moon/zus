...
/**
 * 关系定义持久化仓储接口（基础设施层，仅 fga_relation_definition 单表）
 *
 ...
 * @since 2025-02-06
 */
public interface IModelRelationPersistenceRepository extends IService<RelationDefinitionPO> {
     ...
     */
    List<RelationDefinitionPO> selectByTypeDefinitionId(Long typeDefinitionId);
     ...
     * @return 关系定义列表，无则返回空列表
     */
    List<RelationDefinitionPO> selectByTypeDefinitionId(Set<Long> typeDefinitionId);
     ...
     * @return 关系定义
     */
    Optional<RelationDefinitionPO> selectByRelationName(Long typeDefinitionId, String relationName);
