 ...
 * @since 2025-02-06
 */
public interface IAuthorizationModelPersistenceRepository extends IService<AuthorizationModelPO> {
     ...
     */
    Optional<AuthorizationModelPO> findByModelIdAndStoreId(String storeId, String modelId);
     ...
     * @return 授权模型列表
     */
    List<AuthorizationModelPO> findByStoreId(String storeId);
     ...
     * @return 授权模型列表
     */
    List<AuthorizationModelPO> findByStoreIdAndStatus(String storeId, Integer status);
     ...
     * @return 更新成功返回 true
     */
    boolean updateModel(AuthorizationModelPO model);
     ...
     * @return 存在则返回 Optional 包装的 PO，否则 empty
     */
    Optional<AuthorizationModelPO> findLatestByStoreId(String storeId);
     ...
     * @return 模型列表，按创建时间倒序
     */
    List<AuthorizationModelPO> findPageByCursor(String storeId, Integer status, String pageToken, int pageSize);
}
