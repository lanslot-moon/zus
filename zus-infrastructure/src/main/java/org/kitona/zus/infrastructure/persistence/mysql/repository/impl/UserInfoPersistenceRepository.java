 ...
 * 用户信息持久化仓储实现（基础设施层）
 *
 * <p>基于 MyBatis-Plus 与 IUserInfoMapper 的持久化实现，
 ...
 */
@Repository
public class UserInfoPersistenceRepository extends BaseRepository<UserInfoPO> implements IUserInfoPersistenceRepository {
