...
public class DefaultMetaObjectHandler implements MetaObjectHandler {
    ...
    private final String createTimeFieldName = BeanFieldUtil.getFieldName(BaseDo::getCreateTime);

    private final String updateTimeFieldName = BeanFieldUtil.getFieldName(BaseDo::getUpdateTime);

    private final String createdByFieldName = BeanFieldUtil.getFieldName(BaseDo::getCreatedBy);

    private final String updatedByFieldName = BeanFieldUtil.getFieldName(BaseDo::getUpdatedBy);
