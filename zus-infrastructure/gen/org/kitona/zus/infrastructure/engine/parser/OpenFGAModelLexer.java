...
public class OpenFGAModelLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MODEL", "SCHEMA", "TYPE", "RELATIONS", "DEFINE", "CONDITIONS", "CONDITION", 
			"AS", "WITH", "UNION", "INTERSECTION", "BUT", "NOT", "SELF", "THIS", 
			"FROM", "HASH", "LPAREN", "RPAREN", "COLON", "DOUBLE_COLON", "COMMA", 
			"STAR", "LT", "GT", "LBRACK", "RBRACK", "LBRACE", "RBRACE", "NEWLINE", 
			"IDENTIFIER", "LETTER", "DIGIT", "VERSION", "WS", "COMMENT"
		};
	}
